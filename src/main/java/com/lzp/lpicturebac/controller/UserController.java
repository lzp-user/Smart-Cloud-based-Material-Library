...
import com.lzp.lpicturebac.model.dto.user.*;
import com.lzp.lpicturebac.model.entity.User;
import com.lzp.lpicturebac.model.vo.LoginUserVO;
...
public class UserController {
     ...
     * 用户注册
     */
    //RequestBody 前段就可以传对象格式
    @PostMapping("/register")
    //@AuthCheck(mustRole = UserConstant.ADMIN_ROLE)  //用户注册必须有管理员权限
